...
//	uint8 dutycycle2;
	...
	while(1)
	{
		...
		x1 = MUSART_voidReceiveChar(USART1);
		MUSART_voidSendString(USART1, "USART1 Sent Successfully! \n");
		if(x1 == '5')
		{
			LED_voidLedToggle(GPIOC_ID, PIN14);
		}
		x2 = MUSART_u32ReceiveInteger(USART2, x);
		MUSART_voidSendString(USART2, "USART2 Sent Successfully! \n");
		MPWM_voidSetDutyCycle(TIMER4, 4, x2, 1);
